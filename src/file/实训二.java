    ...
    public static void main(String[] args) throws IOException {
        ...
        while (true) {
            for (int j = 1; ; j++) {
                ...
                System.out.println("x平均值为" + s1 / i);
                System.out.println("x1平均值为" + s11 / i);
                System.out.println("x方差为" + f1 / i);
                System.out.println("x1方差为" + f11 / i);
                BigDecimal ss = new BigDecimal(s2 / i);
                BigDecimal ss1 = new BigDecimal(s21 / i);
                System.out.println("y平均值为" + ss);
                System.out.println("y1平均值为" + ss1);
                System.out.println("y方差为" + f2 / i);
                System.out.println("y1方差为" + f21 / i);
                BigDecimal ss3 = new BigDecimal(s3 / i);
                BigDecimal ss31 = new BigDecimal(s31 / i);
                System.out.println("z平均值为" + ss3);
                System.out.println("z1平均值为" + ss31);
                System.out.println("z方差为" + f3 / i);
                System.out.println("z1方差为" + f31 / i);
            }
        }
